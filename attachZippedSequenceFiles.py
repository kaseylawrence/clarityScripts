...
def upload_matched_files_to_outputs(api, username, password, matches):
    """
...
def main():
    ...
    matches = match_artifacts_to_files(stepArtifacts, ab1_files)

    # Upload matched files to output artifacts
    print("\n" + "="*50)
    print("UPLOADING FILES TO OUTPUT ARTIFACTS")
    print("="*50)
    uploaded_files = upload_matched_files_to_outputs(api, args.username, args.password, matches)
